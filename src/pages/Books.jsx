      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', textAlign: 'left' }}>
          ...
          <div className="rule-card">
            <h3 style={{ fontSize: '1.5rem', color: '#E1A756', marginBottom: '0.5rem', fontWeight: '700' }}>The Momentum Rule</h3>
            ...
            <a href="https://themomentumrule.com" target="_blank" rel="noopener noreferrer" style={{ color: '#A36E39', fontWeight: '700', textDecoration: 'none' }}>Get the Book →</a>
          </div>

          <div className="rule-card">
            <h3 style={{ fontSize: '1.5rem', color: '#E1A756', marginBottom: '0.5rem', fontWeight: '700' }}>The But I Will Era</h3>
          ...
          <div className="rule-card">
            <h3 style={{ fontSize: '1.5rem', color: '#E1A756', marginBottom: '0.5rem', fontWeight: '700' }}>Your Body Is Not Your Soul</h3>
