  ...
  return (
    <div className="landing-container" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem', textAlign: 'center' }}>
        <BookOpen size={64} color="#A36E39" style={{ marginBottom: '1.5rem' }} />
        ...
        <div className="rule-card" style={{ marginBottom: '2rem', textAlign: 'left', borderLeft: '4px solid #A36E39' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div>
              <span style={{ fontSize: '0.9rem', color: '#A36E39', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Article Spotlight</span>
          ...
          <a href="https://www.themomentumrule.com" target="_blank" rel="noopener noreferrer" className="cta-button" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.75rem 1.5rem', background: 'rgba(163, 110, 57, 0.2)', color: '#A36E39', textDecoration: 'none', border: '1px solid #A36E39', fontSize: '1rem' }}>
            Read Full Post on TheMomentumRule.com <ExternalLink size={16} />
          </a>
        </div>

        <div className="rule-card" style={{ marginBottom: '2rem', textAlign: 'left', borderLeft: '4px solid #E1A756' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div>
              <span style={{ fontSize: '0.9rem', color: '#E1A756', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Audio / Chapter Chat</span>
            ...
            <Headphones size={48} color="rgba(225, 167, 86, 0.2)" />
          </div>
          <a href="https://www.themomentumrule.com" target="_blank" rel="noopener noreferrer" className="cta-button" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.75rem 1.5rem', background: '#E1A756', color: '#081C1F', textDecoration: 'none', fontSize: '1rem' }}>
