      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', textAlign: 'left' }}>
          ...
          <div className="rule-card">
            ...
            <a href="https://themomentumrule.com/books/the-momentum-rule" target="_blank" rel="noopener noreferrer" style={{ color: '#8b5cf6', fontWeight: '700', textDecoration: 'none' }}>Get the Book →</a>
          </div>
          ...
          <div className="rule-card">
            ...
            <a href="https://themomentumrule.com/books/the-but-i-will-era" target="_blank" rel="noopener noreferrer" style={{ color: '#8b5cf6', fontWeight: '700', textDecoration: 'none' }}>Get the Book →</a>
          </div>
          ...
          <div className="rule-card">
            ...
            <a href="https://themomentumrule.com/books/your-body-is-not-your-soul" target="_blank" rel="noopener noreferrer" style={{ color: '#8b5cf6', fontWeight: '700', textDecoration: 'none' }}>Get the Book →</a>
          </div>
